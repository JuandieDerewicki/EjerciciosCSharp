...
namespace PruebasDataBinding {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClienteRow AddClienteRow(int Id, string Nombre, string Apellido) {
...
namespace PruebasDataBinding.DataSet1TableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Origina" +
                "l_Nombre) AND ([Apellido] = @Original_Apellido))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cliente] SET [Id] = @Id, [Nombre] = @Nombre, [Apellido] = @Apellido" +
                " WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Apellido] " +
                "= @Original_Apellido));\r\nSELECT Id, Nombre, Apellido FROM Cliente WHERE (Id = @I" +
                "d)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\PruebaBD.mdf;" +
